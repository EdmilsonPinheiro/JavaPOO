...
class Jogador {
    ...
    Jogador(int id, String nome, int altura, int peso, String universidade, int anoNascimento, String cidadeNascimento,
        ...
        this.universidadejogador = universidadejogador;
...
public class hashSeparado {
  private static final String FIM = "FIM";
  private ArrayList<Jogador> jogadores = new ArrayList<>();

  public static void main(String[] args) throws IOException {
	  hashSeparado aplicacao = new hashSeparado();
  ...
  private static void inserirJogadores(Scanner scanner, TabelaHash tabelaHash, hashSeparado aplicacao) {
      String entrada;
      do {
