...
class Jogador {
    private final int idjogador, alturajogador, pesojogador, anoNascimento;
    private final String nomejogador, universidadejogador, cidadeNascimento, estadoNascimento;
    ...
    Jogador(int id, String nome, int altura, int peso, String universidade, int anoNascimento, String cidadeNascimento,
        ...
        this.universidadejogador = universidade;
...
public class Binaria {
    ...
    private static void inserirJogadores(Scanner scanner, ABB arvore, Binaria aplicacao) {
        String entrada;
        do {
    ...
    private static void pesquisarJogadores(Scanner scanner, ABB arvore) {
    ...
    private static void gerarArquivoLog(long tempo, int numComparacoes) throws IOException {
        try (FileWriter writer = new FileWriter("793938_ABB.txt")) {
